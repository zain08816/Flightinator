...
<link rel="stylesheet" type="text/css" href="../css/login.css">
	...
	out.print("<p>locking account "+newEmail+"</p>");
	...
	try {
		...
		if(!result.next()){
		    ...
		    String updateStr = "UPDATE end_user SET locked=1 WHERE ru_email='" + newEmail + "'";
			...
			%>
			<script> 
			    alert("The account: " + newEmail + " has been locked!");
		    	window.location.href = "systemSupport.jsp";
			</script>
			<p class="message">The account has been successfully locked! <a href="systemSupport.jsp">Go Back</a></p>
